...
.text
.protected Custom_Cijk_Ailk_Bljk_F8H_HHS_BH_Bias_GG_AS_SAB_SAV_UserArgs_MT256x144x32_MI16x16x1_GRVWA4_GRVWB2_AF0EM4_WGM8_MO2_DTVA_SwapAB
.globl Custom_Cijk_Ailk_Bljk_F8H_HHS_BH_Bias_GG_AS_SAB_SAV_UserArgs_MT256x144x32_MI16x16x1_GRVWA4_GRVWB2_AF0EM4_WGM8_MO2_DTVA_SwapAB
.p2align 8
.type Custom_Cijk_Ailk_Bljk_F8H_HHS_BH_Bias_GG_AS_SAB_SAV_UserArgs_MT256x144x32_MI16x16x1_GRVWA4_GRVWB2_AF0EM4_WGM8_MO2_DTVA_SwapAB,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Custom_Cijk_Ailk_Bljk_F8H_HHS_BH_Bias_GG_AS_SAB_SAV_UserArgs_MT256x144x32_MI16x16x1_GRVWA4_GRVWB2_AF0EM4_WGM8_MO2_DTVA_SwapAB
...
amdhsa.version:
  ...
  - 1
amdhsa.kernels:
  - .name: Custom_Cijk_Ailk_Bljk_F8H_HHS_BH_Bias_GG_AS_SAB_SAV_UserArgs_MT256x144x32_MI16x16x1_GRVWA4_GRVWB2_AF0EM4_WGM8_MO2_DTVA_SwapAB
    .symbol: 'Custom_Cijk_Ailk_Bljk_F8H_HHS_BH_Bias_GG_AS_SAB_SAV_UserArgs_MT256x144x32_MI16x16x1_GRVWA4_GRVWB2_AF0EM4_WGM8_MO2_DTVA_SwapAB.kd'
    .language:                   OpenCL C
    .language_version:
      - 2
      - 0
...
label_Summation_End_49LA7A59J3Q2ZIS8_0:
...
v_cndmask_b32 v9, v47, v9, s[78:79]                // LDC clip if OOB. offset
buffer_load_dwordx2 v[12:13], v9, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
s_mul_i32 s74, 256, s[sgprWorkGroup0]              // wgp0 * MT0
v_sub_u32 v10, v0, s74
v_lshlrev_b32 v10, 0x2, v10                        // Bias address scaled by BPE
v_cndmask_b32 v10, v47, v10, s[78:79]              // LDBias clip if OOB. offset
s_waitcnt lgkmcnt(0)                               // Wait for Bias LDS write
s_barrier                                          // Bias LDS write barrier
...
v_add_lshl_u32 v9, v3, v0, 0x1                     // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v9, v47, v9, s[78:79]                // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,1,0,0) */
v_add_co_u32 v1, vcc, v1, 1                        // coord1.1: coord1Vgpr += d1*sg1*VW + vc1
...
v_cndmask_b32 v14, v47, v14, s[78:79]              // LDC clip if OOB. offset
...
v_cndmask_b32 v15, v47, v15, s[78:79]              // LDBias clip if OOB. offset
...
v_cndmask_b32 v14, v47, v14, s[78:79]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,2,0,0) */
v_add_co_u32 v1, vcc, v1, 1                        // coord1.1: coord1Vgpr += d1*sg1*VW + vc1
...
v_cndmask_b32 v29, v47, v29, s[78:79]              // LDC clip if OOB. offset
...
v_cndmask_b32 v36, v47, v36, s[78:79]              // LDBias clip if OOB. offset
...
v_cndmask_b32 v29, v47, v29, s[78:79]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,3,0,0) */
v_add_co_u32 v1, vcc, v1, 1                        // coord1.1: coord1Vgpr += d1*sg1*VW + vc1
...
v_cndmask_b32 v44, v47, v44, s[78:79]              // LDC clip if OOB. offset
buffer_load_dwordx2 v[48:49], v44, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
s_mul_i32 s74, 256, s[sgprWorkGroup0]              // wgp0 * MT0
v_sub_u32 v45, v0, s74
v_lshlrev_b32 v45, 0x2, v45                        // Bias address scaled by BPE
v_cndmask_b32 v45, v47, v45, s[78:79]              // LDBias clip if OOB. offset
...
v_cndmask_b32 v44, v47, v44, s[78:79]              // LDD clip if OOB. offset
v_accvgpr_read_b32 v[vgprValuC+24], acc0           // copy acc to vreg[0]
v_accvgpr_read_b32 v[vgprValuC+25], acc4           // copy acc to vreg[1]
v_accvgpr_read_b32 v[vgprValuC+26], acc8           // copy acc to vreg[2]
v_accvgpr_read_b32 v[vgprValuC+27], acc12          // copy acc to vreg[3]
