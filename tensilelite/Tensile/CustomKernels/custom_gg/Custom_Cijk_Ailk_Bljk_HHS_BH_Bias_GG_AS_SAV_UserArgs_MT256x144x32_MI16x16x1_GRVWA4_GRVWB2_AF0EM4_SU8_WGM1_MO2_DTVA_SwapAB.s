...
.text
.protected Custom_Cijk_Ailk_Bljk_HHS_BH_Bias_GG_AS_SAV_UserArgs_MT256x144x32_MI16x16x1_GRVWA4_GRVWB2_AF0EM4_SU8_WGM1_MO2_DTVA_SwapAB
.globl Custom_Cijk_Ailk_Bljk_HHS_BH_Bias_GG_AS_SAV_UserArgs_MT256x144x32_MI16x16x1_GRVWA4_GRVWB2_AF0EM4_SU8_WGM1_MO2_DTVA_SwapAB
.p2align 8
.type Custom_Cijk_Ailk_Bljk_HHS_BH_Bias_GG_AS_SAV_UserArgs_MT256x144x32_MI16x16x1_GRVWA4_GRVWB2_AF0EM4_SU8_WGM1_MO2_DTVA_SwapAB,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Custom_Cijk_Ailk_Bljk_HHS_BH_Bias_GG_AS_SAV_UserArgs_MT256x144x32_MI16x16x1_GRVWA4_GRVWB2_AF0EM4_SU8_WGM1_MO2_DTVA_SwapAB
...
amdhsa.version:
  ...
  - 1
amdhsa.kernels:
  - .name: Custom_Cijk_Ailk_Bljk_HHS_BH_Bias_GG_AS_SAV_UserArgs_MT256x144x32_MI16x16x1_GRVWA4_GRVWB2_AF0EM4_SU8_WGM1_MO2_DTVA_SwapAB
    .symbol: 'Custom_Cijk_Ailk_Bljk_HHS_BH_Bias_GG_AS_SAV_UserArgs_MT256x144x32_MI16x16x1_GRVWA4_GRVWB2_AF0EM4_SU8_WGM1_MO2_DTVA_SwapAB.kd'
    .language:                   OpenCL C
    .language_version:
      - 2
      - 0
...
s_waitcnt lgkmcnt(0), vmcnt(5)                     // vmcnt(5) = 7 - 1 (beta) - 1 (scaleAlphaVec) lgkmcnt(0) = 1 - 1 (bias) (interleaved)
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v20, 1.0, v20, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_cndmask_b32 v21, 1.0, v21, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_pk_mul_f32 v[vgprValuC+24:vgprValuC+24+1], v[20:21], v[vgprValuC+24:vgprValuC+24+1] // *= scaleAlphaVecVMulPK(20)(0)
...
s_waitcnt vmcnt(5)                                 // vmcnt(4) = 7 - 2 (beta) - 1 (scaleAlphaVec) (interleaved)
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v20, 1.0, v20, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_cndmask_b32 v21, 1.0, v21, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_pk_mul_f32 v[vgprValuC+32:vgprValuC+32+1], v[20:21], v[vgprValuC+32:vgprValuC+32+1] // *= scaleAlphaVecVMulPK(20)(0)
...
s_waitcnt vmcnt(5)                                 // vmcnt(3) = 7 - 3 (beta) - 1 (scaleAlphaVec) (interleaved)
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v20, 1.0, v20, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_cndmask_b32 v21, 1.0, v21, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_pk_mul_f32 v[vgprValuC+36:vgprValuC+36+1], v[20:21], v[vgprValuC+36:vgprValuC+36+1] // *= scaleAlphaVecVMulPK(20)(0)
...
s_waitcnt vmcnt(5)                                 // vmcnt(2) = 7 - 4 (beta) - 1 (scaleAlphaVec) (interleaved)
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v20, 1.0, v20, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_cndmask_b32 v21, 1.0, v21, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_pk_mul_f32 v[vgprValuC+44:vgprValuC+44+1], v[20:21], v[vgprValuC+44:vgprValuC+44+1] // *= scaleAlphaVecVMulPK(20)(0)
...
s_waitcnt vmcnt(5)                                 // vmcnt(1) = 7 - 5 (beta) - 1 (scaleAlphaVec) (interleaved)
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v20, 1.0, v20, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_cndmask_b32 v21, 1.0, v21, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
...
s_waitcnt vmcnt(5)                                 // vmcnt(0) = 7 - 6 (beta) - 1 (scaleAlphaVec) (interleaved)
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v20, 1.0, v20, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_cndmask_b32 v21, 1.0, v21, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
...
v_accvgpr_read_b32 v[vgprValuC+26], acc26          // copy acc to vreg[26]
v_accvgpr_read_b32 v[vgprValuC+27], acc30          // copy acc to vreg[27]
v_accvgpr_read_b32 v[vgprValuC+32], acc19          // copy acc to vreg[28]
v_accvgpr_read_b32 v[vgprValuC+33], acc23          // copy acc to vreg[29]
v_accvgpr_read_b32 v[vgprValuC+34], acc27          // copy acc to vreg[30]
...
v_accvgpr_read_b32 v[vgprValuC+26], acc74          // copy acc to vreg[74]
v_accvgpr_read_b32 v[vgprValuC+27], acc78          // copy acc to vreg[75]
v_accvgpr_read_b32 v[vgprValuC+32], acc67          // copy acc to vreg[76]
v_accvgpr_read_b32 v[vgprValuC+33], acc71          // copy acc to vreg[77]
v_accvgpr_read_b32 v[vgprValuC+34], acc75          // copy acc to vreg[78]
...
v_accvgpr_read_b32 v[vgprValuC+26], acc122         // copy acc to vreg[122]
v_accvgpr_read_b32 v[vgprValuC+27], acc126         // copy acc to vreg[123]
v_accvgpr_read_b32 v[vgprValuC+32], acc115         // copy acc to vreg[124]
v_accvgpr_read_b32 v[vgprValuC+33], acc119         // copy acc to vreg[125]
v_accvgpr_read_b32 v[vgprValuC+34], acc123         // copy acc to vreg[126]
v_accvgpr_read_b32 v[vgprValuC+35], acc127         // copy acc to vreg[127]
v_mov_b32 v[vgprValuC+36], v[vgprAcc-128+128]         // copy acc to vreg[128]
v_mov_b32 v[vgprValuC+37], v[vgprAcc-128+132]         // copy acc to vreg[129]
v_mov_b32 v[vgprValuC+38], v[vgprAcc-128+136]         // copy acc to vreg[130]
v_mov_b32 v[vgprValuC+39], v[vgprAcc-128+140]         // copy acc to vreg[131]
...
v_accvgpr_read_b32 v[vgprValuC+32], acc33          // copy acc to vreg[36]
v_accvgpr_read_b32 v[vgprValuC+33], acc37          // copy acc to vreg[37]
v_accvgpr_read_b32 v[vgprValuC+34], acc41          // copy acc to vreg[38]
v_accvgpr_read_b32 v[vgprValuC+35], acc45          // copy acc to vreg[39]
v_accvgpr_read_b32 v[vgprValuC+40], acc34          // copy acc to vreg[40]
v_accvgpr_read_b32 v[vgprValuC+41], acc38          // copy acc to vreg[41]
v_accvgpr_read_b32 v[vgprValuC+42], acc42          // copy acc to vreg[42]
v_accvgpr_read_b32 v[vgprValuC+43], acc46          // copy acc to vreg[43]
...
v_mov_b32 v[vgprValuC+32], v[vgprAcc-128+129]         // copy acc to vreg[132]
v_mov_b32 v[vgprValuC+33], v[vgprAcc-128+133]         // copy acc to vreg[133]
v_mov_b32 v[vgprValuC+34], v[vgprAcc-128+137]         // copy acc to vreg[134]
v_mov_b32 v[vgprValuC+35], v[vgprAcc-128+141]         // copy acc to vreg[135]
v_mov_b32 v[vgprValuC+40], v[vgprAcc-128+130]         // copy acc to vreg[136]
v_mov_b32 v[vgprValuC+41], v[vgprAcc-128+134]         // copy acc to vreg[137]
v_mov_b32 v[vgprValuC+42], v[vgprAcc-128+138]         // copy acc to vreg[138]
v_mov_b32 v[vgprValuC+43], v[vgprAcc-128+142]         // copy acc to vreg[139]
