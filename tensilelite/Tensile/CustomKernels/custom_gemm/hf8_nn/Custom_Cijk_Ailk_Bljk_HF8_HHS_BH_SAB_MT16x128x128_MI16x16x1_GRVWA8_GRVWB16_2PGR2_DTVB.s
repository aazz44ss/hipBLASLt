...
.text
.protected Custom_Cijk_Ailk_Bljk_HF8_HHS_BH_SAB_MT16x128x128_MI16x16x1_GRVWA8_GRVWB16_2PGR2_DTVB
.globl Custom_Cijk_Ailk_Bljk_HF8_HHS_BH_SAB_MT16x128x128_MI16x16x1_GRVWA8_GRVWB16_2PGR2_DTVB
.p2align 8
.type Custom_Cijk_Ailk_Bljk_HF8_HHS_BH_SAB_MT16x128x128_MI16x16x1_GRVWA8_GRVWB16_2PGR2_DTVB,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Custom_Cijk_Ailk_Bljk_HF8_HHS_BH_SAB_MT16x128x128_MI16x16x1_GRVWA8_GRVWB16_2PGR2_DTVB
...
amdhsa.version:
  ...
  - 1
amdhsa.kernels:
  - .name: Custom_Cijk_Ailk_Bljk_HF8_HHS_BH_SAB_MT16x128x128_MI16x16x1_GRVWA8_GRVWB16_2PGR2_DTVB
    .symbol: 'Custom_Cijk_Ailk_Bljk_HF8_HHS_BH_SAB_MT16x128x128_MI16x16x1_GRVWA8_GRVWB16_2PGR2_DTVB.kd'
    .language:                   OpenCL C
    .language_version:
      - 2
      - 0
...
// Cache Swizzle
s_or_b32 s[sgprSrdA+1], s[sgprSrdA+1], Srd63_32
s_or_b32 s[sgprSrdB+1], s[sgprSrdB+1], Srd63_32
...
s_cmp_eq_u32 s[sgprShadowLimitB+1], 0              // are we within 2^32?
s_cselect_b32 s[sgprSrdB+2], s[sgprShadowLimitB+0], BufferLimit // Move shadow to real if we are within 2^32
s_add_u32 s[sgprStaggerUIter], s[sgprStaggerUIter], 3 // Subtract (PGR-1); StaggerUIter now contains target iteration to wrap
...
buffer_load_dwordx4 v[vgprG2LB+4:vgprG2LB+4+3], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], 0 offen offset:64 // G -> Reg 0_0_4_0
buffer_load_dwordx4 v[vgprG2LB+8:vgprG2LB+8+3], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+0] offen offset:0 // G -> Reg 0_0_1_0
buffer_load_dwordx4 v[vgprG2LB+12:vgprG2LB+12+3], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+0] offen offset:64 // G -> Reg 0_0_5_0
...
// Cache Swizzle
s_or_b32 s[sgprSrdC+1], s[sgprSrdC+1], Srd63_32
s_or_b32 s[sgprSrdD+1], s[sgprSrdD+1], Srd63_32
...
buffer_load_dwordx4 v[vgprG2LB2+4:vgprG2LB2+4+3], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], 0 offen offset:64 // G -> Reg 0_0_4_0
buffer_load_dwordx4 v[vgprG2LB2+8:vgprG2LB2+8+3], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+0] offen offset:0 // G -> Reg 0_0_1_0
buffer_load_dwordx4 v[vgprG2LB2+12:vgprG2LB2+12+3], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+0] offen offset:64 // G -> Reg 0_0_5_0
...
/* global read inc A loopL */
s_add_u32 s74, s[sgprLoopCounterL], 2              // remove pf(2)
s_cmp_eq_u32 s[sgprStaggerUIter], s74              // Is this wrapIter? (pf)
s_cselect_b32 s72, s[sgprWrapUA+0], s[sgprGlobalReadIncsA+0] // incLower <- ?
s_cselect_b32 s73, s[sgprWrapUA+1], 0              // incUpper <- ?
s_add_u32 s[sgprSrdA+0], s[sgprSrdA+0], s72        // gra SRD += inc(lower)
...
/*  mfmaIndex:0  */
s_waitcnt lgkmcnt(4)                               // wait for prior local read local write old=0, new=0 newLW=0 newLR=0
...
ds_read_u16 v[vgprValuA_X2_I0+0], v[vgprLocalReadAddrA] offset:256 // L -> Reg lro=512 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=0 oIdx=0 buffer=2 iui=0
ds_read_u16_d16_hi v[vgprValuA_X2_I0_D1+0], v[vgprLocalReadAddrA] offset:288 // L -> Reg lro=512 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=1 oIdx=0 buffer=2 iui=0
ds_read_u16 v[vgprValuA_X2_I0+1], v[vgprLocalReadAddrA] offset:320 // L -> Reg lro=512 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=2 oIdx=0 buffer=2 iui=0
...
ds_read_u16_d16_hi v[vgprValuA_X2_I0_D1+1], v[vgprLocalReadAddrA] offset:352 // L -> Reg lro=512 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=3 oIdx=0 buffer=2 iui=0
ds_read_u16 v[vgprValuA_X3_I0+0], v[vgprLocalReadAddrA] offset:384 // L -> Reg lro=576 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=0 oIdx=0 buffer=3 iui=0
ds_read_u16_d16_hi v[vgprValuA_X3_I0_D1+0], v[vgprLocalReadAddrA] offset:416 // L -> Reg lro=576 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=1 oIdx=0 buffer=3 iui=0

v_mfma_f32_16x16x16_f16 acc[4:7], v[vgprValuB_X0_I0+4+0+0:vgprValuB_X0_I0+4+0+0+1], v[vgprValuA_X0_I0+0+0+0:vgprValuA_X0_I0+0+0+0+1], acc[4:7] // left value = acc[4+0:7+0]
/*  mfmaIndex:2  */

s_waitcnt lgkmcnt(6)                               // wait for prior local read local write old=0, new=3 newLW=0 newLR=3
...
ds_read_u16 v[vgprValuA_X3_I0+1], v[vgprLocalReadAddrA] offset:448 // L -> Reg lro=576 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=2 oIdx=0 buffer=3 iui=0
ds_read_u16_d16_hi v[vgprValuA_X3_I0_D1+1], v[vgprLocalReadAddrA] offset:480 // L -> Reg lro=576 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=3 oIdx=0 buffer=3 iui=0
ds_read_u16 v[vgprValuA_X4_I0+0], v[vgprLocalReadAddrA] offset:2176 // L -> Reg lro=1024 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=0 oIdx=0 buffer=4 iui=0
...
ds_read_u16_d16_hi v[vgprValuA_X4_I0_D1+0], v[vgprLocalReadAddrA] offset:2208 // L -> Reg lro=1024 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=1 oIdx=0 buffer=4 iui=0
ds_read_u16 v[vgprValuA_X4_I0+1], v[vgprLocalReadAddrA] offset:2240 // L -> Reg lro=1024 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=2 oIdx=0 buffer=4 iui=0
ds_read_u16_d16_hi v[vgprValuA_X4_I0_D1+1], v[vgprLocalReadAddrA] offset:2272 // L -> Reg lro=1024 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=3 oIdx=0 buffer=4 iui=0

v_mfma_f32_16x16x16_f16 acc[4:7], v[vgprValuB_X0_I0+4+2+0:vgprValuB_X0_I0+4+2+0+1], v[vgprValuA_X1_I0+0+0+0:vgprValuA_X1_I0+0+0+0+1], acc[4:7] // left value = acc[4+0:7+0]
/*  mfmaIndex:4  */

s_waitcnt lgkmcnt(8)                               // wait for prior local read local write old=0, new=3 newLW=0 newLR=3
...
ds_read_u16 v[vgprValuA_X5_I0+0], v[vgprLocalReadAddrA] offset:2304 // L -> Reg lro=1088 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=0 oIdx=0 buffer=5 iui=0
ds_read_u16_d16_hi v[vgprValuA_X5_I0_D1+0], v[vgprLocalReadAddrA] offset:2336 // L -> Reg lro=1088 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=1 oIdx=0 buffer=5 iui=0
ds_read_u16 v[vgprValuA_X5_I0+1], v[vgprLocalReadAddrA] offset:2368 // L -> Reg lro=1088 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=2 oIdx=0 buffer=5 iui=0
...
ds_read_u16_d16_hi v[vgprValuA_X5_I0_D1+1], v[vgprLocalReadAddrA] offset:2400 // L -> Reg lro=1088 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=3 oIdx=0 buffer=5 iui=0
ds_read_u16 v[vgprValuA_X6_I0+0], v[vgprLocalReadAddrA] offset:2432 // L -> Reg lro=1536 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=0 oIdx=0 buffer=6 iui=0
ds_read_u16_d16_hi v[vgprValuA_X6_I0_D1+0], v[vgprLocalReadAddrA] offset:2464 // L -> Reg lro=1536 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=1 oIdx=0 buffer=6 iui=0

v_mfma_f32_16x16x16_f16 acc[4:7], v[vgprValuB_X2_I0+4+0+0:vgprValuB_X2_I0+4+0+0+1], v[vgprValuA_X2_I0+0+0+0:vgprValuA_X2_I0+0+0+0+1], acc[4:7] // left value = acc[4+0:7+0]
/*  mfmaIndex:6  */

s_waitcnt lgkmcnt(10)                               // wait for prior local read local write old=0, new=2 newLW=0 newLR=2
...
ds_read_u16 v[vgprValuA_X6_I0+1], v[vgprLocalReadAddrA] offset:2496 // L -> Reg lro=1536 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=2 oIdx=0 buffer=6 iui=0
ds_read_u16_d16_hi v[vgprValuA_X6_I0_D1+1], v[vgprLocalReadAddrA] offset:2528 // L -> Reg lro=1536 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=3 oIdx=0 buffer=6 iui=0
...
ds_read_u16 v[vgprValuA_X7_I0+0], v[vgprLocalReadAddrA] offset:2560 // L -> Reg lro=1600 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=0 oIdx=0 buffer=7 iui=0
ds_read_u16_d16_hi v[vgprValuA_X7_I0_D1+0], v[vgprLocalReadAddrA] offset:2592 // L -> Reg lro=1600 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=1 oIdx=0 buffer=7 iui=0

v_mfma_f32_16x16x16_f16 acc[4:7], v[vgprValuB_X2_I0+4+2+0:vgprValuB_X2_I0+4+2+0+1], v[vgprValuA_X3_I0+0+0+0:vgprValuA_X3_I0+0+0+0+1], acc[4:7] // left value = acc[4+0:7+0]
/*  mfmaIndex:8  */
...
ds_read_u16 v[vgprValuA_X7_I0+1], v[vgprLocalReadAddrA] offset:2624 // L -> Reg lro=1600 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=2 oIdx=0 buffer=7 iui=0
ds_read_u16_d16_hi v[vgprValuA_X7_I0_D1+1], v[vgprLocalReadAddrA] offset:2656 // L -> Reg lro=1600 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=3 oIdx=0 buffer=7 iui=0
...
v_mfma_f32_16x16x16_f16 acc[4:7], v[vgprValuB_X4_I0+4+0+0:vgprValuB_X4_I0+4+0+0+1], v[vgprValuA_X4_I0+0+0+0:vgprValuA_X4_I0+0+0+0+1], acc[4:7] // left value = acc[4+0:7+0]
/*  mfmaIndex:10  */

s_waitcnt lgkmcnt(8)                               // wait for prior local read local write old=0, new=2 newLW=0 newLR=2
...
ds_write_b128 v[vgprLocalWriteAddrA], v[vgprG2LA2+0:vgprG2LA2+0+3] offset:0 // lwoA_0_0_0_0 = (0*LSCA) + (0*LSPA)(*MT0I+PAD) = 0

buffer_load_dwordx4 v[vgprG2LB+0:vgprG2LB+0+3], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], 0 offen offset:0 // G -> Reg 0_0_0_0
buffer_load_dwordx4 v[vgprG2LB+4:vgprG2LB+4+3], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], 0 offen offset:64 // G -> Reg 0_0_6_0

v_mfma_f32_16x16x16_f16 acc[4:7], v[vgprValuB_X4_I0+4+2+0:vgprValuB_X4_I0+4+2+0+1], v[vgprValuA_X5_I0+0+0+0:vgprValuA_X5_I0+0+0+0+1], acc[4:7] // left value = acc[4+0:7+0]
/*  mfmaIndex:12  */

s_waitcnt lgkmcnt(5)                              // wait for prior local read local write old=0, new=11 newLW=9 newLR=2
...
v_mfma_f32_16x16x16_f16 acc[4:7], v[vgprValuB_X6_I0+4+0+0:vgprValuB_X6_I0+4+0+0+1], v[vgprValuA_X6_I0+0+0+0:vgprValuA_X6_I0+0+0+0+1], acc[4:7] // left value = acc[4+0:7+0]
/*  mfmaIndex:14  */
...
v_mfma_f32_16x16x16_f16 acc[4:7], v[vgprValuB_X6_I0+4+2+0:vgprValuB_X6_I0+4+2+0+1], v[vgprValuA_X7_I0+0+0+0:vgprValuA_X7_I0+0+0+0+1], acc[4:7] // left value = acc[4+0:7+0]

s_waitcnt vmcnt(6)                                 // 8wait for global read
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+0+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X0_I0+0+0], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X0_I0+0+0], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+0+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X0_I0+0+1], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X0_I0+0+1], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+0+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X0_I0+0+2], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X0_I0+0+2], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+0+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X0_I0+0+3], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X0_I0+0+3], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
...
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+2+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X2_I0+0+0], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X2_I0+0+0], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+2+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X2_I0+0+1], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X2_I0+0+1], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+2+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X2_I0+0+2], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X2_I0+0+2], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+2+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X2_I0+0+3], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X2_I0+0+3], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
...
s_waitcnt vmcnt(5)                                 // 8wait for global read
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+4+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X4_I0+0+0], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X4_I0+0+0], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+4+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X4_I0+0+1], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X4_I0+0+1], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+4+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X4_I0+0+2], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X4_I0+0+2], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+4+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X4_I0+0+3], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X4_I0+0+3], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
...
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+6+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X6_I0+0+0], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X6_I0+0+0], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+6+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X6_I0+0+1], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X6_I0+0+1], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+6+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X6_I0+0+2], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X6_I0+0+2], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+6+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X6_I0+0+3], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X6_I0+0+3], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
...
buffer_load_dwordx4 v[vgprG2LB+8:vgprG2LB+8+3], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+0] offen offset:0 // G -> Reg 0_0_3_0
buffer_load_dwordx4 v[vgprG2LB+12:vgprG2LB+12+3], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+0] offen offset:64 // G -> Reg 0_0_7_0

s_waitcnt vmcnt(6)                                 // 8wait for global read
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+8+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X1_I0+0+0], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X1_I0+0+0], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+8+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X1_I0+0+1], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X1_I0+0+1], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+8+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X1_I0+0+2], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X1_I0+0+2], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+8+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X1_I0+0+3], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X1_I0+0+3], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
...
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+10+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X3_I0+0+0], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X3_I0+0+0], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+10+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X3_I0+0+1], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X3_I0+0+1], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+10+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X3_I0+0+2], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X3_I0+0+2], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+10+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X3_I0+0+3], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X3_I0+0+3], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
...
s_waitcnt vmcnt(5)                                 // 8wait for global read
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+12+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X5_I0+0+0], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X5_I0+0+0], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+12+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X5_I0+0+1], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X5_I0+0+1], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+12+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X5_I0+0+2], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X5_I0+0+2], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+12+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X5_I0+0+3], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X5_I0+0+3], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
...
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+14+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X7_I0+0+0], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X7_I0+0+0], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+14+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X7_I0+0+1], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X7_I0+0+1], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+14+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X7_I0+0+2], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X7_I0+0+2], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[vgprCVT0:vgprCVT1], v[vgprG2LB2+14+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprValuB_X7_I0+0+3], v[vgprCVT0] dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprValuB_X7_I0+0+3], v[vgprCVT1] dst_sel:WORD_1 // Convert to FP16
...
/*  numMfmaForLR:1, syncPlrMfmaIndex:14  */
/*  mfmaIndex:12  */
s_waitcnt lgkmcnt(4)                               // wait for prior local read local write old=0, new=2 newLW=0 newLR=2
v_or_b32 v[vgprValuA_X6_I0+0], v[vgprValuA_X6_I0+0], v[vgprValuA_X6_I0_D1+0] // pack two half Vgpr to one Vgpr
v_or_b32 v[vgprValuA_X6_I0+1], v[vgprValuA_X6_I0+1], v[vgprValuA_X6_I0_D1+1] // pack two half Vgpr to one Vgpr
s_nop 0
s_nop 0
...
v_add_lshl_u32 v16, v3, v0, 0x2                     // optSingleColVgpr scaleToBpe: sharedAddrVgpr <- cinRowPtr + coord0, scaled by BPE. BSHERE:coord0=0, coord0Vgpr=0
s_lshl_b32 s52, s[sgprStrideD1J], 2                // incToNextRow: Scale by BPE
v_add_u32 v17, v16, s52                     // optSingleColVgpr scaleToBpe: sharedAddrVgpr <- cinRowPtr + coord0, scaled by BPE. BSHERE:coord0=0, coord0Vgpr=0
v_add_u32 v18, v17, s52                     // optSingleColVgpr scaleToBpe: sharedAddrVgpr <- cinRowPtr + coord0, scaled by BPE. BSHERE:coord0=0, coord0Vgpr=0
v_add_u32 v19, v18, s52                     // optSingleColVgpr scaleToBpe: sharedAddrVgpr <- cinRowPtr + coord0, scaled by BPE. BSHERE:coord0=0, coord0Vgpr=0
s_mul_i32 s53, s[sgprStrideD1J], 244               // scale StrideD *= numRows(61) * bpe
v_add_u32 v20, v19, s53                     // optSingleColVgpr scaleToBpe: sharedAddrVgpr <- cinRowPtr + coord0, scaled by BPE. BSHERE:coord0=0, coord0Vgpr=0
v_add_u32 v21, v20, s52                     // optSingleColVgpr scaleToBpe: sharedAddrVgpr <- cinRowPtr + coord0, scaled by BPE. BSHERE:coord0=0, coord0Vgpr=0
v_add_u32 v22, v21, s52                     // optSingleColVgpr scaleToBpe: sharedAddrVgpr <- cinRowPtr + coord0, scaled by BPE. BSHERE:coord0=0, coord0Vgpr=0
v_add_u32 v23, v22, s52                     // optSingleColVgpr scaleToBpe: sharedAddrVgpr <- cinRowPtr + coord0, scaled by BPE. BSHERE:coord0=0, coord0Vgpr=0
...
buffer_store_dword v8, v16, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
// s_lshl_b32 s52, s[sgprStrideD1J], 2                // incToNextRow: Scale by BPE
// s_add_u32 s[sgprSrdD+0], s[sgprSrdD+0], s52        // incToNextRow: gra SRD += inc(lower)
// s_addc_u32 s[sgprSrdD+1], s[sgprSrdD+1], 0         // incToNextRow: gra SRD += inc(upper)
buffer_store_dword v9, v17, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
// s_lshl_b32 s52, s[sgprStrideD1J], 2                // incToNextRow: Scale by BPE
// s_add_u32 s[sgprSrdD+0], s[sgprSrdD+0], s52        // incToNextRow: gra SRD += inc(lower)
// s_addc_u32 s[sgprSrdD+1], s[sgprSrdD+1], 0         // incToNextRow: gra SRD += inc(upper)
